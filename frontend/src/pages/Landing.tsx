...
import { ArrowRight, X, BookOpen, Heart, User, CheckCircle, Boxes, Cpu, HardDrive } from 'lucide-react';
...
export const Landing: React.FC = () => {
  ...
  // Overlay states: 'goal' | 'resources' | 'contact' | 'home' | null
  const [activeOverlay, setActiveOverlay] = useState<'goal' | 'resources' | 'contact' | 'home' | null>(null);
        ...
        <AnimatePresence mode="wait">
          ...
          {activeOverlay === 'home' && (
            ...
            >
              <button 
                onClick={() => setActiveOverlay(null)}
                className="absolute top-4 right-4 text-zinc-550 hover:text-white transition-colors cursor-pointer"
              >
                <X size={16} />
              </button>
